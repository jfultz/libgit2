...
int socket_connect(git_io_stream *stream)
{
...
ssize_t socket_write(git_io_stream *stream, void *data, size_t len, int flags)
{
	ssize_t ret;
	size_t off = 0;
	socket_stream *st = (socket_stream *) stream;
...
ssize_t socket_read(git_io_stream *stream, void *data, size_t len)
{
	ssize_t ret;
	socket_stream *st = (socket_stream *) stream;
...
int socket_close(git_io_stream *stream)
{
	socket_stream *st = (socket_stream *) stream;
...
void socket_free(git_io_stream *stream)
{
	socket_stream *st = (socket_stream *) stream;
...
int git_socket_stream_new(git_io_stream **out, const char *host, const char *port)
{
	socket_stream *st;
